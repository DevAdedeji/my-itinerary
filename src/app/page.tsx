...
export default function Home() {
  return (
    <AppLayout>
      <div className="overflow-hidden min-h-screen bg-white flex flex-col gap-5 p-4 xl:p-8">
        ...
        <div className="flex flex-col xl:flex-row items-start  justify-between gap-4 xl:gap-0">
          <div className="space-y-1 w-full xl:w-auto">
            ...
            <h2 className="text-xl xl:text-2xl text-black font-semibold">
              Bahamas Family Trip
            </h2>
            <div className="flex items-center flex-wrap gap-1 text-sm xl:text-base">
          ...
          <div className="flex items-center gap-2 w-full xl:w-auto justify-between xl:justify-start">
            <button className="bg-primary-100 py-2 px-4 h-[46px] w-full xl:w-40 flex items-center justify-center rounded">
              <UserPlus />
            </button>
