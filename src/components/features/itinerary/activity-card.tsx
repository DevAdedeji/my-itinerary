...
export function ActivityCard({
    ...
    return (
        <div className="bg-white p-4 xl:p-6 relative flex flex-col xl:flex-row gap-6 rounded-lg">
            {/* Carousel */}
            ...
            {/* Main Content */}
            <div className="flex-1 flex flex-col xl:pr-12 min-w-0">
                ...
                <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between mb-4 gap-4">
                    <div className="flex items-center gap-2 text-black-secondary text-base 2xl:text-lg flex-1 min-w-0 flex-wrap">
                        ...
                        <span className="truncate max-w-[200px] xl:max-w-none">Admission to the Empire State Building</span>
            ...
            <div onClick={onRemove} className="w-full h-12 xl:h-auto xl:w-12 flex items-center justify-center bg-[#FBEAE9] rounded-b-lg xl:rounded-b-none xl:rounded-r-lg relative xl:absolute right-0 top-auto xl:top-0 bottom-0 cursor-pointer hover:bg-[#f9d5d3] transition-colors order-last xl:order-0">
