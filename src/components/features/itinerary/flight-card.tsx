...
export function FlightCard({
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 relative flex flex-col xl:flex-row gap-0">
            {/* Main Content */}
            <div className="flex-1 p-4 xl:p-6 xl:pr-20">
                ...
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-8 gap-6">
                    ...
                    <div className="flex flex-col xl:flex-row items-center gap-4 xl:gap-8 2xl:gap-10 flex-1 w-full xl:max-w-[600px] justify-center">
                        <div className="flex items-center justify-between w-full xl:w-auto xl:block text-center shrink-0">
                        ...
                        <div className="flex-1 w-full xl:w-auto grid grid-cols-1 items-center px-4 min-w-[150px]">
                    ...
                    <div className="text-left xl:text-right shrink-0 min-w-[140px] w-full xl:w-auto">
                ...
                {/* Facilities & Actions */}
                <div className="flex items-start xl:items-center justify-between flex-col xl:flex-row gap-4">
            ...
            <div onClick={onRemove} className="w-full h-12 xl:h-auto xl:w-16 flex items-center justify-center bg-[#FBEAE9] rounded-b-lg xl:rounded-b-none xl:rounded-r-lg relative xl:absolute right-0 top-auto xl:top-0 bottom-0 cursor-pointer hover:bg-[#f9d5d3] transition-colors order-last xl:order-0">
